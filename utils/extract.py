...
def extract_data(
    ...
    for page_num in range(1, max_pages + 1):
        ...
        try:
            ...
            # Debug print for page 1 extraction count
            if page_num == 1:
                print(f"[DEBUG] Page 1 extracted {len(products)} items")
...
def _parse_products(soup: BeautifulSoup) -> list[dict]:
    ...
    Struktur DOM:
        ...
        - Price: span atau p dengan class="price"
        - Rating/Colors/Size/Gender: dari tag <p> dengan inline style
    ...
    for card in product_cards:
        try:
            ...
            # Look for either <span class="price"> or <p class="price">
